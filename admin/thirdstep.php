...
include('../dbcon.php');
    ...
    $sql="INSERT INTO `test`.`user_mark`(`u_rollno`,`u_class`,`u_hindi1`, `u_english1`, `u_math1`, `u_physics1`, `u_chemestry1`, `u_hindi2`, `u_english2`, `u_math2`, `u_physics2`, `u_chemestry`) VALUES ('$rollno','$class','$hindi1','$english1','$math1','$physics1','$chemestry1','$hindi2','$english2','$math2','$physics2','$chemestry2')";
